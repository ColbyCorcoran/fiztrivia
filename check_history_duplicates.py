...
# Get newly added questions (his_251 to his_300)
new_question_ids = [f"his_{i:03d}" for i in range(251, 301)]
new_questions = [q for q in history_questions if q['id'] in new_question_ids]

print(f"Checking {len(new_questions)} newly added History questions against {len(history_questions) - len(new_questions)} existing questions...\n")

# Check for duplicates
duplicates_found = []

for new_q in new_questions:
    for existing_q in history_questions:
...
if duplicates_found:
    ...
    print("✅ No duplicates found! All new History questions are unique.")
