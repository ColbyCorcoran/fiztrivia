#!/usr/bin/env python3
"""Comprehensive duplicate verification for all 300 Technology questions"""
import json
...
def main():
    ...
    print(f"Total Technology questions: {len(technology)}")
    print()
    ...
    for i, q1 in enumerate(technology):
        for j, q2 in enumerate(technology[i+1:], i+1):
    ...
    if not (duplicates_exact or duplicates_semantic or duplicates_essential):
        print("🎉 All 300 Technology questions are unique!")
        return 0
    else:
