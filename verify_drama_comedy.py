#!/usr/bin/env python3
"""Verify Drama/Comedy questions for duplicates"""
import json
...
def check_duplicates():
    ...
    # Get the new Drama/Comedy questions (ent_172 to ent_236)
    new_questions = [q for q in all_questions if q['id'] >= 'ent_172' and q['id'] <= 'ent_236']
    existing_questions = [q for q in all_questions if q['id'] < 'ent_172' or q['id'] > 'ent_236']

    print(f"Checking {len(new_questions)} new Drama/Comedy questions against {len(existing_questions)} existing questions...\n")
