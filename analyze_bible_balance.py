#!/usr/bin/env python3
"""
Analyze Bible category balance across subcategories and difficulties
"""
...
def analyze_bible():
    ...
    print("=" * 80)
    print("BIBLE CATEGORY ANALYSIS")
    print("=" * 80)
    print(f"\nTotal Bible Questions: {len(bible_questions)}")
    print(f"Target: 300 questions")
    print(f"Need to add: {300 - len(bible_questions)} questions")
    ...
    # Ideal: 50 questions per subcategory (300 / 6 = 50)
