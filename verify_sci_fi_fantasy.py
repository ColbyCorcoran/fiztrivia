#!/usr/bin/env python3
"""Verify Sci-Fi/Fantasy questions for duplicates"""
import json
...
def check_duplicates():
    ...
    # Get the new Sci-Fi/Fantasy questions (ent_237 to ent_300)
    new_questions = [q for q in all_questions if q['id'] >= 'ent_237' and q['id'] <= 'ent_300']
    existing_questions = [q for q in all_questions if q['id'] < 'ent_237' or q['id'] > 'ent_300']

    print(f"Checking {len(new_questions)} new Sci-Fi/Fantasy questions against {len(existing_questions)} existing questions...\n")
