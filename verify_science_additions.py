#!/usr/bin/env python3
"""
Verify that the 22 new Science questions (sci_279-sci_300) don't duplicate existing questions
"""
...
def check_duplicates():
    ...
    # New questions are sci_279 through sci_300 (22 questions)
    new_question_ids = [f"sci_{i:03d}" for i in range(279, 301)]

    new_questions = [q for q in science_questions if q['id'] in new_question_ids]
    existing_questions = [q for q in science_questions if q['id'] not in new_question_ids]

    print("=" * 80)
    print("DUPLICATE CHECK FOR NEW SCIENCE QUESTIONS")
    print("=" * 80)
    ...
    if not found_issues:
        ...
        print("\nAll 22 new Science questions are unique.")
