#!/usr/bin/env python3
"""Verify Animation questions for duplicates"""
import json
...
def check_duplicates():
    ...
    # Get the new Animation questions (ent_107 to ent_171)
    new_questions = [q for q in all_questions if q['id'] >= 'ent_107' and q['id'] <= 'ent_171']
    existing_questions = [q for q in all_questions if q['id'] < 'ent_107' or q['id'] > 'ent_171']

    print(f"Checking {len(new_questions)} new Animation questions against {len(existing_questions)} existing questions...\n")
