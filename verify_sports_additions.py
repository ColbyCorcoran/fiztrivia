#!/usr/bin/env python3
"""
Verify that the 140 new Sports questions (spt_161-spt_300) don't duplicate existing questions
"""
...
def check_duplicates():
    ...
    # New questions are spt_161 through spt_300 (140 questions)
    new_question_ids = [f"spt_{i:03d}" for i in range(161, 301)]

    new_questions = [q for q in sports_questions if q['id'] in new_question_ids]
    existing_questions = [q for q in sports_questions if q['id'] not in new_question_ids]

    print("=" * 80)
    print("DUPLICATE CHECK FOR NEW SPORTS QUESTIONS")
    print("=" * 80)
    ...
    if not found_issues:
        ...
        print("\nAll 140 new Sports questions are unique.")
