#!/usr/bin/env python3
"""
Analyze Nature category balance across subcategories and difficulties
"""
...
def analyze_nature():
    ...
    print("=" * 80)
    print("NATURE CATEGORY ANALYSIS")
    print("=" * 80)
    print(f"\nTotal Nature Questions: {len(nature_questions)}")
    print(f"Target: 300 questions")
    print(f"Need to add: {300 - len(nature_questions)} questions")
    ...
    num_subcats = len(by_subcat)
    target_per_subcat = target_total // num_subcats

    print(f"\nTarget per subcategory: ~{target_per_subcat} questions ({num_subcats} subcategories)")
    print()
