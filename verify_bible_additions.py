#!/usr/bin/env python3
"""
Verify the 34 new Bible questions don't duplicate existing questions
"""
...
def check_duplicates():
    ...
    # New question IDs (bib_267 to bib_300)
    new_question_ids = [f"bib_{i:03d}" for i in range(267, 301)]

    new_questions = [q for q in bible_questions if q['id'] in new_question_ids]
    existing_questions = [q for q in bible_questions if q['id'] not in new_question_ids]

    print("=" * 80)
    print("DUPLICATE CHECK FOR NEW BIBLE QUESTIONS")
    print("=" * 80)
    ...
    if not found_issues:
        ...
        print("\nAll 34 new Bible questions are unique.")
