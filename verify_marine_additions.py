#!/usr/bin/env python3
"""
Verify that the 44 new Oceans & Marine Life questions (nat_301-nat_344) don't duplicate existing questions
"""
...
def check_duplicates():
    ...
    # New questions are nat_301 through nat_344 (44 questions)
    new_question_ids = [f"nat_{i:03d}" for i in range(301, 345)]
    ...
    print("=" * 80)
    print("DUPLICATE CHECK FOR NEW OCEANS & MARINE LIFE QUESTIONS")
    print("=" * 80)
    ...
    if not found_issues:
        ...
        print("\nAll 44 new Oceans & Marine Life questions are unique.")
