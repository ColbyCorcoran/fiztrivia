#!/usr/bin/env python3
"""Comprehensive duplicate verification for all 300 Literature questions"""
import json
...
def main():
    ...
    print(f"Total Literature questions: {len(literature)}")
    print()
    ...
    for i, q1 in enumerate(literature):
        for j, q2 in enumerate(literature[i+1:], i+1):
    ...
    if not (duplicates_exact or duplicates_semantic or duplicates_essential):
        print("🎉 All 300 Literature questions are unique!")
        return 0
    else:
